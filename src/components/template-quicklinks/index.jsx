const Quicklinks = ({ passedData }) => {
  return (
    <div className="quicklinksContainer mt-4">
      ...
      {passedData.secondText ? <button className="text-[.5rem] tracking-wide pt-2 pb-2 px-5 border-[1px] border-[var(--theme-black)] dark:border-white rounded-full uppercase hover:bg-[var(--theme-pink)] hover:border-[var(--theme-pink)]" onClick={()=> console.log("test")}>{passedData.secondText} &#8594;</button> : null}
    </div>
  );
};
